...
def load_tafeng_data(task='repurchase'):
    if task == 'repurchase':
...
def main():
    ...
    parser.add_argument('--task', type=str, default='repurchase', choices=['customer_risk_classification', 'repurchase'], help='Task type')
