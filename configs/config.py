...
class Config:
    ...
    RETAIL_DATA_DIR = Path('/root/datasets')
    RETAIL_PROCESSED_DIR = RETAIL_DATA_DIR / 'retail_processed'
    ...
    CDNOW_DATA_DIR = Path('/root/datasets')
    CDNOW_PROCESSED_DIR = CDNOW_DATA_DIR / 'cdnow_processed'
    ...
    INSTACART_DATA_DIR = Path('/root/datasets')
    INSTACART_PROCESSED_DIR = INSTACART_DATA_DIR / 'instacart_processed'
    ...
    SALES_WEEKLY_DATA_DIR = Path('/root/datasets')
    SALES_WEEKLY_PROCESSED_DIR = SALES_WEEKLY_DATA_DIR / 'sales_weekly_processed'
    ...
    TAFENG_DATA_DIR = DATA_DIR
    TAFENG_PROCESSED_DIR = DATA_DIR / 'tafeng_processed'
