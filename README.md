...
- **Merchant**: Multi-industry transaction data (Industries 0-3)
- **Retail**: Online retail customer behavior
- **CDNOW**: Music purchase patterns
- **Instacart**: Grocery shopping behavior
- **TaFeng**: Hypermarket transaction records
- **Sales Weekly**: Product sales forecasting
