...
def train_cdnow_model(args):
    """Main training function for CDNOW dataset - follows train.py pattern"""
    ...
    ts_input_dim = sample['ts_data'].shape[0]
...
def main():
    ...
    parser.add_argument('--order', type=int, default=None, help='Taylor expansion order ')
    parser.add_argument('--n-experts', type=int, default=None, help='Number of MoK experts ')
    parser.add_argument('--n-heads', type=int, default=None, help='Number of attention heads ')
    parser.add_argument('--output-json', type=str, default=None, help='Path to save JSON output ')
