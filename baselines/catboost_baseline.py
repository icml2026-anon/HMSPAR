...
def main():
    ...
    if args.multi_seed:
        ...
        print("="*80)
        print(f"MULTI-SEED STATISTICAL ANALYSIS - CATBOOST {args.dataset.upper()}")
        print("="*80)
        ...
        for i, seed in enumerate(seeds, 1):
            ...
            result = run_catboost_single_seed(args, seed)
    ...
    run_catboost_single_seed(args, 42)

def run_catboost_single_seed(args, seed):
    """Run CatBoost with a specific seed and return results"""
    
    print("=" * 80)
    print(" CatBoost Baseline ".center(80, "="))
    print("=" * 80)
    ...
    suffix = ''
    result_filename = f'catboost_{result_name}{suffix}_results.csv'
