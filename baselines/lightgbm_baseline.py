...
def main():
    ...
    if args.multi_seed:
        ...
        print("="*80)
        print(f"MULTI-SEED STATISTICAL ANALYSIS - LIGHTGBM {args.dataset.upper()}")
        print("="*80)
        ...
        for i, seed in enumerate(seeds, 1):
            ...
            result = run_lightgbm_single_seed(args, seed)
    ...
    run_lightgbm_single_seed(args, 42)

def run_lightgbm_single_seed(args, seed):
    """Run LightGBM with a specific seed and return results"""
    
    print("=" * 80)
    print(" LightGBM Baseline ".center(80, "="))
    print("=" * 80)
    ...
    suffix = ''
    result_filename = f'lightgbm_{result_name}{suffix}_results.csv'
